            ...
            <div class="container">
                <div class="row align-items-center no-gutters demo-selector">
                    <div class="col-12" style="padding-top : 2rem">
                        <h2 class="entry-title main_title">Manhattan Manor Website Accessibility Statement</h2>

                        <div style="margin-top : 2rem;">                               
                            <p>At Manhattan Manor, we are committed to providing website accessibility to the widest possible audience, regardless of technology or ability.
                            <p class="mt-4">We recommend that you use CHROME as a browser. <a href="https://www.google.com/chrome/" target="_blank">To download CHROME, click here</a>.</p>
                            <p class="mt-4">You can increase font size in your browser.</p>
                            <p class="mt-4">We are always striving to improve our capabilities and we aim to comply with all applicable standards, including WCAG 2.0 accessibility standards.</p>
                            <p class="mt-5">
                                If you experience any difficulty accessing any part of our website or you need personal help, please contact us by
                                <br /><br />Emailing us at <br /><a href="mailto:ada@manhattanmanor.com">ada@manhattanmanor.com </a>
                                <br /><br />or calling us at <br /><a href="tel:1-212-489-9595">1-212-489-9595</a>
                            </p>
                            <p class="mt-4">For 24 hour service, call<br /><a href="tel:1-917-626-6055">1-917-626-6055</a></p>
                        </div>
                    </div>
                </div>
            </div>
