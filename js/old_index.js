    ...
    items: [
        {
          ...
          title: 'View of Empty Skylight room with seven chandeliers, mahogany floors, steel beams, skylight studded 20 foot ceiling.'
        },
        {
          src: '/img/skylight-gallery/49225452751_a1a6a47d1a_b.jpg',
          title: 'Close up of flower arrangement with Skylight Room set up for a dinner behind.'
        },
        {
          src: '/img/skylight-gallery/49115629823_f73446bf03_b.jpg',
          title: 'The Skylight set up for a fashion show with spectators watching a model walking down the runway.'
        },
        {
          src: '/img/skylight-gallery/49165180023_1203c97983_k.jpg',
          title: 'Close up mirror and light fixture with image of the Skylight Room.'
        },
        {
          src: '/img/skylight-gallery/49116040812_d33407f528_k.jpg',
          title: 'The Skylight room set for a promotional event with red and blue uplighting.'
        },
        {
          src: '/img/skylight-gallery/47620037512_d66892476f_b.jpg',
          title: 'Detail of bookshelf at the Skylight Room with flowers and candles and the lounge furniture in the center of the room.'
        },
        {
          src: '/img/skylight-gallery/33795469008_3486e3bd1d_b.jpg',
          title: 'Detail of head table overlooking seventh avenue at and event in the Skylight Room.'
        },
        {
          src: '/img/skylight-gallery/49576229538_020a9d0012_b.jpg',
          title: 'Guests dancing at a wedding at the Skylight Room.'
        },
        {
          src: '/img/skylight-gallery/49576230003_63fe1af7c0_b.jpg',
          title: 'Skylight Room set for dinner with light from Times Square filling the room.'
        },
        {
          src: '/img/skylight-gallery/49115257973_c070798091_k.jpg',
          title: 'View of  the band performing and guests dancing in the Skylight Room.'
        },
        {
          src: '/img/skylight-gallery/49225799782_259fad90d0_k.jpg',
          title: 'Close up of a tables set for dinner in the Skylight Room.'
        },
        {
          src: '/img/mc-gallery/49581169342_018cbd3931_o.jpg',
          title: 'Guest dressed in flapper style in the Skylight Room.'
        },
        {
          src: '/img/skylight-gallery/49165661291_1cabf46ded_k.jpg',
          title: 'View of empty Skylight Room with its mahogany floors, brick walls, grey ceiling, antique chandeliers, and French windows on two sides of the room.'
        },
    ],
    callbacks: {
    ...
    items: [
        {
          ...
          title: 'View of Empty Manhattan Club with details of lighting, wooden panneling, and French windows.'
        },
        {
          src: '/img/mc-gallery/49115619268_dc1b2c8149_b.jpg',
          title: 'Conference with panel of 5 speakers at head table.'
        },
        {
          src: '/img/mc-gallery/51307584448_62399296c9_k.jpg',
          title: 'View of the empty Manhattan Club with parquet wood and French windows.'
        },
        {
          src: '/img/mc-gallery/49115344198_6e703149fd_k.jpg',
          title: 'Product launch at the Manhattan Club with lounge furniture.'
        },
        {
          src: '/img/mc-gallery/51306649902_2e30362da1_k.jpg',
          title: 'Manhattan Club set for conference with head table, pull down screen, blackout shades and coffee station.'
        },
        {
          src: '/img/mc-gallery/49116121996_3b423f4c74_b.jpg',
          title: 'Close up of beautiful lace wedding cake with a conference being held in the background in the Manhattan Club.'
        },
        {
          src: '/img/mc-gallery/51306648432_9212a5e4cb_k.jpg',
          title: 'View of empty Manhattan Manor from the south side.'
        },
        {
          src: '/img/mc-gallery/49576231408_64d95d95c2_o.jpg',
          title: 'View of Taco station at The Manhattan Club with chef preparing and ready to serve.'
        },
        {
          src: '/img/mc-gallery/49116164507_a00c75fd7b_o.jpg',
          title: 'Circus performers – Man on stilts and two dancers - at the Manhattan Club.'
        },
        {
          src: '/img/mc-gallery/51307389871_6da3859d90_k.jpg',
          title: 'View of the Manhattan Club including the large bar in the center and the entrance.'
        },
        {
          src: '/img/mc-gallery/51309768579_eeaab473e0_o.jpg',
          title: 'Guests serving themselves at a food station during a reception at the Manhattan Club.'
        },
        {
          src: '/img/mc-gallery/51310059780_0681475510_o.jpg',
          title: 'Meditteranean Station at the Manhattan Club.'
        },
        {
          src: '/img/mc-gallery/51307379361_b112394adc_k.jpg',
          title: 'View of the South East Corner of the Manhattan Club, details of overhead lighting and windows.'
        },
        /*
        {
...
$('#btn-subscribe').click(function() {
  ...
  $('#btn-subscribe').html('<i style="letter-spacing : initial; font-size : 150%;" class="fas fa-spinner fa-pulse"></i>');
  ...
  var postData = { 
    ...
    eventdate : $('#inputProposedDate').val(), 
    eventtime : $('#inputProposedTime').val(), 
    guests : $('#inputGuests').val(), 
    eventtype : $('#inputEventType').val(), 
    g_captcha: grecaptcha.getResponse(),
    notes : $('#inputMessage').val()
  };

  if (document.getElementById('inputSubscribe').checked) {
      // Set the default checkbox value if checked
      postData.subscribe = 'on';
  }

  $.post('/process_subscription.php', postData)
  .done(function(data) {
    $('#contact-form-container').html(
      '<h1 class="text-white text-center">Thank you, we will contact you soon!</h1>'
    );
  })
  .fail(function(data) {
    $('#contact-form-container').html(
      '<h1 class="text-white text-center">An error has occurred!</h1>'
    );
...
$('#btn-subscribe-modal').click(function() {
  ...
  $('#btn-subscribe-modal').html('<i style="letter-spacing : initial; font-size : 150%;" class="fas fa-spinner fa-pulse"></i>');
  ...
  .done(function(data) {
    $('.form-cell').html(
      '<h2 class="text-white text-center">Thank you, we will contact you soon!</h2>' +
...
function growDiv() {
  ...
  button.innerHTML = ('Show More' == button.innerHTML) ? 'Show Less' : 'Show More';
}
