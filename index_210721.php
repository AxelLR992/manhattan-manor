                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-12 col-md-6 pt-5 pt-md-0">
                        ...
                        <div class="text-center">
                            ...
                            <div>
                                <button class="header-button fill skylight-video" style="width : 250px;" aria-label="Open Skylight Room video"><i class="far fa-play-circle"></i>&nbsp;Video</button>
                            </div>
                    ...
                    <div class="col-12 col-md-6 pt-5 pt-md-0">                       
                        ...
                        <div class="text-center">
                            ...
                            <div>
                                <button class="header-button fill mc-video" style="width : 250px;" aria-label="Open Manhattan Club Room video"><i class="far fa-play-circle"></i>&nbsp;Video</button>
                            </div>
        ...
        <section id="event-type" class="event-type-section">
            <div class="container-fluid">
                ...
                <div class="row justify-content-center no-gutters stagger-tween">
                    <div class="col-md-6 col-xl-4 p-2 stagger-tween-item">
                    ...
                    <div class="col-md-6 col-xl-4 p-2 stagger-tween-item">
                        <div class="reveal-container">
                        <img alt="Film and Photo event photo" class="img-fluid" src="img/events/ev-mitzvah.jpg" />
                        <h5 class="text-white text-uppercase text-shadow p-3 px-lg-4" style="position : absolute; bottom : 0px;">Film and Photo</h5>
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                    ...
                    <div class="col-md-6 col-xl-4 p-2 stagger-tween-item">
                        <div class="reveal-container">
                        <img alt="Galas and Fund Raisings event photo" class="img-fluid" src="img/events/ev-fashion.jpg" />
                        <h5 class="text-white text-uppercase text-shadow p-3 px-lg-4" style="position : absolute; bottom : 0px;">Galas and Fund Raisings</h5>
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                    ...
                    <div class="col-md-6 col-xl-4 p-2 stagger-tween-item">
                        <div class="reveal-container">
                        <img alt="Meetings event photo" class="img-fluid" src="img/events/ev-product.jpg" />
                        <h5 class="text-white text-uppercase text-shadow p-3 px-lg-4" style="position : absolute; bottom : 0px;">Meetings</h5>
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
